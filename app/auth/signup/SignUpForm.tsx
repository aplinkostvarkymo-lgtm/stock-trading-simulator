    ...
    <div className="space-y-6">
      ...
      <form action={handleSubmit} className="space-y-4">
        <div>
          ...
          {errors.name && (
            <p className="mt-1 text-sm text-danger-red">{errors.name[0]}</p>
          )}
        </div>
        ...
        <div>
          ...
          {errors.email && (
            <p className="mt-1 text-sm text-danger-red">{errors.email[0]}</p>
          )}
        </div>
        ...
        <div>
          ...
          {errors.password && (
            <p className="mt-1 text-sm text-danger-red">{errors.password[0]}</p>
          )}
        </div>

        <div>
          <label htmlFor="confirmPassword" className="block text-sm font-medium text-terminal-text mb-2">
            Confirm Password
          </label>
          <div className="relative">
            <Lock className="absolute left-3 top-1/2 -translate-y-1/2 w-5 h-5 text-terminal-muted" />
          ...
          {errors.confirmPassword && (
            <p className="mt-1 text-sm text-danger-red">{errors.confirmPassword[0]}</p>
          )}
        </div>
        ...
        <button
          type="submit"
          disabled={loading}
          className="w-full py-3 px-4 bg-success-green hover:bg-green-600 text-white font-semibold rounded-lg transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
        >
          {loading ? (
            <>
